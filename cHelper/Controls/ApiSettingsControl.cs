...
public class ApiSettingsControl : UserControl
{
    ...
    private void BuildUI()
    {
        ...
        _toggleBtn = new Button { Text = "Show", Width = 50, Height = 23 };
        _toggleBtn.Click += (_, _) => ToggleKeyVisibility();
        _validateBtn = new Button { Text = "Validate", Width = 65, Height = 23 };
        ...
        var saveKeyBtn = new Button { Text = "Save API Key", Width = 110, Height = 25 };
        saveKeyBtn.Click += (_, _) => SaveApiKey();
        layout.Controls.Add(saveKeyBtn, 0, 3);

        // Model
        layout.Controls.Add(MakeSectionLabel("Default Model"), 0, 4);
        _modelCombo = new ComboBox { Width = 280, DropDownStyle = ComboBoxStyle.DropDownList };
        ...
        _startupCheck = new CheckBox { Text = "Start with Windows", AutoSize = true };
